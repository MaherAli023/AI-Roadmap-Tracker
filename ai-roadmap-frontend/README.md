...
We use Pocketbase, a minimal and fast open-source backend similar to Firebase, to store the data. The schema of the tables can be found in the Backend Folder. More information about Pocketbase can be found in their [GitHub repository](https://github.com/pocketbase/pocketbase).
